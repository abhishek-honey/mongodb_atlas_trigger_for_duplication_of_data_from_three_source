exports = async function(changeEvent) {
    ...
    console.log("duplicate_data_from_source_2_to_target: changeEvent: ", JSON.stringify(changeEvent));
    ...
    try {
      ...
      console.log("duplicate_data_from_source_2_to_target: error performing mongodb write: ", err.message);
    }
  };